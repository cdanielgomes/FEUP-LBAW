...
<body>
  ...
  <main>
        ...
        <div id="products_title" class="jumptarget">
          <div class="cards row">
            ...
            <div class="col-md-6 col-xl-6 ml-auto d-flex align-items-center justify-content-end">
              <div id="addAlterButton" class="box d-flex flex-column last-card" data-toggle="modal" data-target="#addProductModal">
                &#10010; Add Product
              </div>
            </div>
          </div>
    ...
    <div class="row">
      ...
      <div class="mt-3 col-md-5 col-lg-4">
        <div class="box d-flex flex-column align-items-center">
          <img src="assets/boots.png" alt="Item 1" class="center-block" onclick="window.location='product.html'" style="cursor:pointer;">
          <h5 id="productName" onclick="window.location='product.html'" style="cursor:pointer;">Men's
            Tsumoru Boot</h5>
          <div class="details">
          ...
          <form>
            <div class="modal-body section-container mt-0">
              ...
              <div class="form-group">
                ...
                <textarea rows="4" cols="10" class="form-control">Insert product description</textarea>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="dropdown">
                  <button class="btn btn-secondary btn-block" type="button" id="dropdownMenuButton" data-toggle="dropdown"
      ...
      <section class="py-5" id="discounts-section">
        ...
        <div id="discounts_title" class="jumptarget">
          ...
          <div class="cards row">
            ...
            <div class="col-md-6 col-xl-6 ml-auto d-flex align-items-center justify-content-end">
              <div id="addAlterButton" class="box d-flex flex-column last-card" data-toggle="modal" data-target="#addDiscountModal">
                &#10010; Add Discount
              </div>
            </div>
          </div>
